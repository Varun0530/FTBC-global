...
const leaderboardData: LeaderboardEntry[] = [
  { rank: 1, initials: "HS", name: "Hans Schmidt", country: "Germany", adoptionRate: 98, businessUnit: "Operations" },
  { rank: 2, initials: "SM", name: "Sophie Martin", country: "France", adoptionRate: 96, businessUnit: "Supply Chain" },
  { rank: 3, initials: "JB", name: "James Brown", country: "United Kingdom", adoptionRate: 95, businessUnit: "Quality" },
  { rank: 4, initials: "AM", name: "Ahmed Mohammed", country: "UAE", adoptionRate: 94, businessUnit: "Manufacturing" },
  { rank: 5, initials: "LM", name: "Luca Moretti", country: "Italy", adoptionRate: 93, businessUnit: "R&D" },
  { rank: 6, initials: "EK", name: "Emma Karlsson", country: "Sweden", adoptionRate: 92, businessUnit: "Logistics" },
  { rank: 7, initials: "PV", name: "Pieter van der Berg", country: "Netherlands", adoptionRate: 91, businessUnit: "Sales" },
  { rank: 8, initials: "OA", name: "Omar Al-Rashid", country: "Saudi Arabia", adoptionRate: 90, businessUnit: "Customer Success" },
  { rank: 9, initials: "NK", name: "Nkem Okonkwo", country: "Nigeria", adoptionRate: 89, businessUnit: "Digital" },
  { rank: 10, initials: "YK", name: "Yusuf Kaya", country: "Turkey", adoptionRate: 88, businessUnit: "Procurement" },
];


export default function EMEALeaderboardPage() {
      ...
      <div className="leaderboard-container">
        ...
        <div className="content-wrapper">
          <div className="leaderboard-card">
            <h1 className="leaderboard-title">EMEA Region Leaderboard</h1>
            <table 
              className="leaderboard-table" 
              role="table"
              aria-label="EMEA Region Leaderboard showing top 10 participants"
            >
              <thead>
                <tr>
                  <th>#</th>

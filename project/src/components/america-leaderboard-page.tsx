...
const leaderboardData: LeaderboardEntry[] = [
  { rank: 1, initials: "JS", name: "James Smith", country: "United States", adoptionRate: 98, businessUnit: "Operations" },
  { rank: 2, initials: "MS", name: "Mariana Santos", country: "Brazil", adoptionRate: 96, businessUnit: "Supply Chain" },
  { rank: 3, initials: "RW", name: "Robert Williams", country: "United States", adoptionRate: 95, businessUnit: "Quality" },
  { rank: 4, initials: "PB", name: "Patricia Brown", country: "Canada", adoptionRate: 94, businessUnit: "Manufacturing" },
  { rank: 5, initials: "MD", name: "Michael Davis", country: "United States", adoptionRate: 93, businessUnit: "R&D" },
  { rank: 6, initials: "DO", name: "Diego Oliveira", country: "Brazil", adoptionRate: 92, businessUnit: "Logistics" },
  { rank: 7, initials: "JG", name: "Jennifer Garcia", country: "United States", adoptionRate: 91, businessUnit: "Sales" },
  { rank: 8, initials: "AC", name: "Ana Costa", country: "Brazil", adoptionRate: 90, businessUnit: "Customer Success" },
  { rank: 9, initials: "DT", name: "David Thompson", country: "Canada", adoptionRate: 89, businessUnit: "Digital" },
  { rank: 10, initials: "SM", name: "Santiago Martinez", country: "Argentina", adoptionRate: 88, businessUnit: "Procurement" },
];


export default function AmericaLeaderboardPage() {
      ...
      <div className="leaderboard-container">
        ...
        <div className="content-wrapper">
          <div className="leaderboard-card">
            <h1 className="leaderboard-title">America Region Leaderboard</h1>
            <table 
              className="leaderboard-table" 
              role="table"
              aria-label="America Region Leaderboard showing top 10 participants"
            >
              <thead>
                <tr>
                  <th>#</th>
